...
export default function Projects() {
    ...
    return (
        <div className="min-h-screen justify-evenly row-auto">
            ...
            <ProjectBlock title="Course Evaluations ✅" details="My first full stack application, made using the MERN stack." image="/public/course-logo.jpeg" github="https://github.com/realdevvora/course-evaluations" actual="https://evaluation-frontend.onrender.com/"/>
        </div>
    )
}